  ...
  with open(options.index_file, "r", encoding="utf8") as session_file:
    ...
    for row in tsv_reader:
      ...
      if not skip == "1":
        ...
        ffmpeg_command += "[1:v] null [fondo]; " #Changes to background image, currently a null filter to preserve it with no changes
        ffmpeg_command += "[fondo][ckey] overlay=25:0 [fondo_y_spectrum]; "
